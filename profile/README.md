...
**🧑‍🏫 칠판 등록**  : 졸업 편지를 받을 수 있는 칠판을 생성해 보아요~!

**💘 이메일로 칠판 url 전송** : 내 칠판 url이 무엇이었드라? 까먹지 않도록! 입력한 이메일로 칠판 url을 보내드려요~!

**📝 칠판 편지 작성** : 상대방에게 졸업 축하의 문구와 새로운 시작에 대한 응원 메시지를 남겨보아요~!

**💌 칠판 꾸미기 ( 스티커 🌟)** : 스티커로 칠판을 꾸며서 받는 사람도 기분 좋고! 쓰는 사람도 좋아요~!

**🎉 디데이 카운트** : 졸업식날에 편지를 공개합니다! 기분 좋은 졸업식 되세요~! 
